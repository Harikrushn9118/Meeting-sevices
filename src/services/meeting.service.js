...
class MeetingService {
  static async createMeeting(title, participants, meetingDate, transcript, createdBy) {
    return await MeetingModel.create(title, participants, meetingDate, transcript, createdBy);
  }
